...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return <h2 className="font-bebas text-[28px] md:text-[38px] leading-[1.12] text-[var(--text)] mb-3">{children}</h2>;
}

function Card({ children, gold }: { children: React.ReactNode; gold?: boolean }) {
  return (
    <div className="bg-[#111] rounded-xl p-6" style={{ border: gold ? "0.5px solid #c8a96e33" : "0.5px solid var(--bg-card2)" }}>
      {children}
    </div>
  );
}
...
export default function MarketingPlanPage() {
  ...
  return (
    <main className="bg-[var(--bg-deep)] text-[var(--text)] min-h-screen">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg-deep)]/95 backdrop-blur-sm" style={{ borderBottom: "0.5px solid var(--bg-card2)" }}>
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <a href="/" className="text-[14px] text-[var(--text)] font-medium">Sohaib Mehmood</a>
        ...
        {/* Section nav */}
        <div className="max-w-6xl mx-auto px-6 overflow-x-auto scrollbar-hide" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
            {[
              ...
              <div key={s.label} className="bg-[#111] rounded-xl p-4 text-center" style={{ border: "0.5px solid var(--bg-card2)" }}>
      ...
      <section id="positioning" className="py-16 px-6" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <Card gold>
            ...
            <p className="font-bebas text-[22px] md:text-[28px] text-[var(--text)] leading-snug">
          ...
          <div className="mt-8">
            <h3 className="text-[16px] font-medium text-[var(--text)] mb-4">Key Differentiators</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
              {differentiators.map((d, i) => (
                <div key={i} className="flex items-start gap-3 bg-[#111] rounded-xl p-4" style={{ border: "0.5px solid var(--bg-card2)" }}>
      ...
      <section id="avatars" className="py-16 px-6 bg-[var(--bg-deep)]" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {avatars.map((a) => (
              <div key={a.title} className="bg-[#111] rounded-xl p-6 flex flex-col" style={{ border: a.tag === "Primary" ? "1px solid #c8a96e44" : "0.5px solid var(--bg-card2)" }}>
                {a.tag === "Primary" && (
                ...
                <h3 className="text-[16px] font-bebas text-[var(--text)] mt-3 mb-4">{a.title}</h3>
                ...
                <div className="bg-[var(--bg-deep)] rounded-lg p-3 mb-3" style={{ border: "0.5px solid var(--bg-card)" }}>
      ...
      <section id="pain-points" className="py-16 px-6" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div>
              <h3 className="text-[14px] font-medium text-[var(--text)] mb-4 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#e85d5d]" />
                E-Commerce Owners
              </h3>
              <div className="space-y-2">
                {painPointsEcom.map((p, i) => (
                  <div key={i} className="bg-[#111] rounded-lg p-3 flex items-start gap-3" style={{ border: "0.5px solid var(--bg-card2)" }}>
          ...
          <div className="grid md:grid-cols-3 gap-3">
            {desires.map((d, i) => (
              <div key={i} className="bg-[#111] rounded-xl p-4 flex items-start gap-3" style={{ border: "0.5px solid var(--bg-card2)" }}>
      ...
      <section id="competitors" className="py-16 px-6 bg-[var(--bg-deep)]" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
            ...
            {competitors.map(c => (
              <Card key={c.type}>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-[15px] font-medium text-[var(--text)]">{c.type}</h3>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-[var(--bg-deep)] rounded-lg p-3" style={{ border: "0.5px solid #c8a96e22" }}>
      ...
      <section id="funnel" className="py-16 px-6" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
            ...
            {funnelStages.map((stage, si) => (
              <div key={stage.stage} className="relative">
                ...
                <div className="flex items-start gap-4 md:gap-6">
                  <div className="shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-[12px] text-[#c8a96e] font-semibold" style={{ border: "1px solid #c8a96e44", background: "var(--bg-deep)" }}>
                    {stage.stage}
                  </div>
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                      <h3 className="text-[18px] font-bebas text-[var(--text)]">{stage.name}</h3>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
                      {stage.tactics.map(t => (
                        <div key={t.title} className="bg-[#111] rounded-lg p-4" style={{ border: "0.5px solid var(--bg-card2)" }}>
                          <h4 className="text-[13px] font-medium text-[var(--text)] mb-1">{t.title}</h4>
      ...
      <section id="platforms" className="py-16 px-6 bg-[var(--bg-deep)]" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
            ...
            {platforms.map(tier => (
              <div key={tier.tier}>
                <div className="flex items-center gap-3 mb-4">
                  <h3 className="text-[15px] font-medium text-[var(--text)]">Tier: {tier.tier}</h3>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {tier.items.map(p => (
                    <div key={p.name} className="bg-[#111] rounded-xl p-5" style={{ border: tier.tier === "Primary" ? "0.5px solid #c8a96e33" : "0.5px solid var(--bg-card2)" }}>
                      <div className="flex items-center gap-3 mb-3">
                        <span className="text-[24px]">{p.icon}</span>
                        <h4 className="text-[15px] font-medium text-[var(--text)]">{p.name}</h4>
                      </div>
      ...
      {/* 7. Budget Allocation */}
      <section id="budget" className="py-16 px-6" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-3 mb-8">
            {budget.map(b => (
              <div key={b.category} className="bg-[#111] rounded-xl p-4" style={{ border: "0.5px solid var(--bg-card2)" }}>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[13px] text-[var(--text)] font-medium">{b.category}</span>
                ...
                <div className="w-full h-2 bg-[var(--bg-card)] rounded-full overflow-hidden mb-2">
          ...
          <div className="bg-[#111] rounded-xl p-5 flex items-center justify-between" style={{ border: "1px solid #c8a96e44" }}>
            <span className="text-[16px] font-medium text-[var(--text)]">Total</span>
      ...
      <section id="sprint" className="py-16 px-6 bg-[var(--bg-deep)]" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-10">
            {sprint.map(w => (
              <div key={w.week} className="bg-[#111] rounded-xl p-6" style={{ border: "0.5px solid var(--bg-card2)" }}>
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-[16px] font-bebas text-[var(--text)]">{w.week}</h3>
                    <p className="text-[12px] text-[#c8a96e]">{w.title}</p>
                  </div>
                  <span className="text-[11px] text-[#555] bg-[var(--bg-deep)] px-3 py-1 rounded" style={{ border: "0.5px solid var(--bg-card)" }}>
                    {w.days}
                  </span>
                </div>
                <div className="space-y-2">
          ...
          {/* Targets */}
          <h3 className="text-[16px] font-medium text-[var(--text)] mb-4">30-Day Targets</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-10">
            {targets.map(t => (
              <div key={t.metric} className="bg-[#111] rounded-xl p-4 text-center" style={{ border: "0.5px solid var(--bg-card2)" }}>
      ...
      {/* Final CTA */}
      <section className="py-16 px-6" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-3xl mx-auto text-center">
          <Card gold>
            <p className="text-[10px] uppercase tracking-[0.15em] text-[#c8a96e] mb-4">The Bottom Line</p>
            <p className="font-bebas text-[20px] md:text-[26px] text-[var(--text)] leading-snug mb-4">
            ...
            <div className="bg-[var(--bg-deep)] rounded-lg p-4 mb-6" style={{ border: "0.5px solid #c8a96e33" }}>
            ...
            <p className="font-bebas text-[18px] text-[var(--text)] italic">
      ...
      {/* Footer */}
      <footer className="py-6 px-6" style={{ borderTop: "0.5px solid var(--bg-card)" }}>
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="text-[11px] text-[#444]">Sohaib Mehmood &mdash; Full Marketing Strategy 2026</span>
          <a href="/" className="text-[11px] text-[#444] hover:text-[var(--text)] transition-colors">Back to Main Site</a>
        </div>
      </footer>
    </main>
  );
