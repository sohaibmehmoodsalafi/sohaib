  ...
  return (
    <section className="py-8 px-6 md:px-8" data-animate>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="font-bebas text-[24px] md:text-[30px] leading-snug text-[var(--text)] mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-8">
          {[
            ...
            <div key={item.problem} className="bg-[#111] rounded-xl p-5 text-left" style={{ border: "0.5px solid var(--bg-card2)" }}>
              <span className="text-[20px] mb-3 block">{item.icon}</span>
              <p className="text-[13px] text-[var(--text)] font-medium mb-1">{item.problem}</p>
        ...
        <div className="bg-[#111] rounded-xl p-5 text-left max-w-xl mx-auto" style={{ border: "0.5px solid #c8a96e33" }}>
          <p className="text-[13px] text-[var(--text)] font-medium mb-1">✦ My approach is different.</p>
