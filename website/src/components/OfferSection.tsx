...
const inputStyle: React.CSSProperties = {
  width: "100%", background: "#1e1e1e", border: "1px solid rgba(255,255,255,.1)",
    ...
    >
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{ fontSize: 15, color: "#9a9a9a", lineHeight: 1.7, marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 12, color: "#6b6b6b", textAlign: "center", marginBottom: 26 }}>Fastest — reply within 1 hour</p>

          {/* Divider */}
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 26 }}>
            <span style={{ flex: 1, height: 1, background: "rgba(255,255,255,.08)" }} />
            <span style={{ fontSize: 12, color: "#6b6b6b", fontWeight: 600 }}>or fill this 30-second form</span>
            <span style={{ flex: 1, height: 1, background: "rgba(255,255,255,.08)" }} />
          </div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16, justifyContent: "center", marginTop: 24 }}>
            {CHECKS.map((c, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 7, fontSize: 12.5, color: "#9a9a9a" }}>
