    ...
    <section id="process" className="py-20 px-6" data-animate>
      <div className="max-w-[1140px] mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-10">
          ...
          <a href="https://wa.me/923048885206" target="_blank" rel="noopener noreferrer" className="px-6 py-3 text-[14px] text-[#F0EDE8] font-light rounded-[2px] hover:bg-white/[0.03] transition-colors flex items-center gap-2" style={{ border: "0.5px solid rgba(255,255,255,0.1)" }}>
