    ...
    <section id="process" className="py-20 px-6" data-animate>
      <div className="max-w-[1140px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {steps.map((s) => (
            <div key={s.num} className="rounded-[2px] p-6 text-center" style={{ background: "var(--bg-card)", border: "0.5px solid var(--hairline)" }}>
              ...
              <h3 className="text-[14px] font-medium text-[var(--text)] mb-2">{s.title}</h3>
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-10">
          ...
          <a href="https://wa.me/923048885206" target="_blank" rel="noopener noreferrer" className="px-6 py-3 text-[14px] text-[var(--text)] font-light rounded-[2px] hover:bg-white/[0.03] transition-colors flex items-center gap-2" style={{ border: "0.5px solid var(--hairline-2)" }}>
