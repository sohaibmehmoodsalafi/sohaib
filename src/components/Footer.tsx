...
const socials = [
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/sohaibmehmoodsalafi",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/sohaibsalafi1996/",
...
export default function Footer() {
  return (
    <footer className="py-6 px-6 md:px-8" style={{ borderTop: "0.5px solid #1a1a1a" }}>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-[11px] text-[#444]">© 2026</span>
        </div>

        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
          {navLinks.map((link) => (
            <a key={link.href} href={link.href} className="text-[11px] text-[#444] hover:text-[#f0ede6] transition-colors">
              {link.label}
            </a>
          ))}
        </div>
        ...
        <div className="flex items-center gap-3">
          {socials.map((s) => (
            <a
              ...
              className="text-[#555] hover:text-[#f0ede6] transition-colors"
              aria-label={s.label}
            >
              {s.icon}
            </a>
